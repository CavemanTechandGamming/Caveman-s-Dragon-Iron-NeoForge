...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        // ===== Armor =====
        trimmedArmorItem(ModItems.DRAGON_IRON_HELMET);
        trimmedArmorItem(ModItems.DRAGON_IRON_CHESTPLATE);
        trimmedArmorItem(ModItems.DRAGON_IRON_LEGGINGS);
        trimmedArmorItem(ModItems.DRAGON_IRON_BOOTS);

    }

    private void trimmedArmorItem(DeferredItem<ArmorItem> itemDeferredItem) {
        final String MOD_ID = CavemansDragonIron.MOD_ID; // Change this to your mod id
